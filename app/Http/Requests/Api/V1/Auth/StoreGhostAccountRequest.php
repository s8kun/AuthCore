...
class StoreGhostAccountRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...$rules,
            ...app(BuildProjectUserValidationRules::class)->for($project, $this->resolveExistingGhostAccount($project)),
        ];
    }
        ...
        return [
            function (Validator $validator): void {
                ...
                $allowedKeys = app(BuildProjectUserValidationRules::class)
                    ->for($project, $this->resolveExistingGhostAccount($project));
    ...
    /**
     * Resolve the existing ghost account for the submitted email address.
     */
    private function resolveExistingGhostAccount(Project $project): ?ProjectUser
    {
        $email = $this->input('email');
